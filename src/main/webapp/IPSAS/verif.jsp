...
<body>
	...
	<div class="container">
		...
		<ol class="breadcrumb">
			...
			<li class="active">Confirmation your account</li>
		</ol>
		...
		<div class="row">
			...
			<article class="col-xs-12 maincontent">
				<header class="page-header">
					<h1 class="page-title">Confirmation your account</h1>
				</header>
				
				<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
					<div class="panel panel-default">
						<div class="panel-body">
							<h3 class="thin text-center"> Your Profil :</h3>
							<hr>
							...
							<jsp:setProperty property="*" name="user"/>
								...
								<div class="top-margin">
									...
									<input type="text" name="first_name" class="form-control" value='${sessionScope.user.first_name }' readonly>
								</div>
								<div class="top-margin">
									<label>Last Name</label>
									<input type="text" name="last_name" class="form-control" value='${sessionScope.user.last_name }' readonly>
								</div>
								<div class="top-margin">
								...
								<div class="row top-margin">
									<div class="col-sm-6">
										...
										<input type="text" name="pwd" class="form-control" value='${sessionScope.user.pwd }' readonly>
									</div>
